...
def main():
    ...
    params = 'Driver={ODBC Driver 17 for SQL Server};Server=192.168.0.28;Database=db_LMS;uid=sa;pwd=P@ssw0rd;'
...
if __name__ == '__main__':
    tbl_name = sys.argv[2]
    logFile = r"/home/ubuntu/myPython/mdm/log/MDMExportDataLMS_{}.log".format(tbl_name)
