...
def main():
    ...
    params = 'Driver={ODBC Driver 17 for SQL Server};Server=192.168.2.63;Database=db_Analytic;uid=tableau_it;pwd=P@ssw0rd;'
    params = urllib.parse.quote_plus(params)

    db = create_engine('mssql+pyodbc:///?odbc_connect=%s' % params, fast_executemany=True)

    str_sql = """
        SELECT * FROM dbo.CRM_Questionnaire_Pivot
    """
...
if __name__ == '__main__':
    tbl_name = sys.argv[2]
    logFile = r"/home/ubuntu/myPython/mdm/log/MDMExportDataEQN63_{}.log".format(tbl_name)
